...
| **미래 예측력** | **AUROC 0.737** (2024년 검증 기준, 보수적 필터링 적용 환경) |
| **실용성 지표(PAI)**| **PAI@20% = 1.99** (서울 상위 20% 위험 구역만 관리해도 전체 사고의 약 40% 사전 예방 가능) |
...
| 지표 | 결과 | 의미 (논문 디펜스 포인트) |
|---|---|---|
| **미래 예측 AUROC** | **0.737** | 랜덤 분할(Random split)이 아닌 2024년 홀드아웃 검증으로 실제 미래 예측력 입증. 산/강 등 비도로 구역을 제거한 가혹한 조건에서도 우수한 판별력. |
| **전체 기간 AUROC** | **0.820** | 전체 기간 기준 강건한 분류 성능. |
| **PAI@10%** | **1.89** | 상위 10% 위험 격자 단속 시, 2024년 전체 PM 사고의 약 19% 사전 예방 가능. |
| **PAI@20%** | **1.99** | 상위 20% 위험 격자 단속 시, 2024년 전체 PM 사고의 약 40% 사전 예방 가능 (무작위 단속 대비 2배 효율). |
